...
namespace ez.Core.Dependency {
    ...
    internal class Container : IContainer {
        ...
        public object Create( Type type, string name = null ) {
            return Helpers.Web.HttpContext?.RequestServices != null ? GetServiceFromHttpContext( type, name ) : GetService( type, name );
        }
        ...
        private object GetServiceFromHttpContext( Type type, string name ) {
            var serviceProvider = Helpers.Web.HttpContext.RequestServices;
            if( name == null )

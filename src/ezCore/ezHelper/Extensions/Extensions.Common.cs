...
namespace ez.Core
{
    ...
    {
        public static void CheckNotNull(this object value, string nameof)
        {
        ...
        {
            return ez.Core.Helpers.EnumHelper.GetValue(instance.GetType(), instance);
        }
        ...
        {
            return ez.Core.Helpers.Convert.To<TResult>(Value(instance));
        }
        ...
        {
            return ez.Core.Helpers.EnumHelper.GetDescription(instance.GetType(), instance);
        }
        ...
        {
            return ez.Core.Helpers.String.Join(list, quotes, separator);
        }
    }
}

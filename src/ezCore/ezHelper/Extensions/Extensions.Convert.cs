...
namespace ez.Core
{
    ...
    public static partial class Extensions
    {
        ...
        {
            return ez.Core.Helpers.Convert.ToBool(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToBoolOrNull(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToInt(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToIntOrNull(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToLong(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToLongOrNull(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToDouble(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToDoubleOrNull(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToDecimal(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToDecimalOrNull(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToDate(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToDateOrNull(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToGuid(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToGuidOrNull(obj);
        }
        ...
        {
            return ez.Core.Helpers.Convert.ToGuidList(obj);
        }
